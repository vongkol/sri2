    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/activity-achieve')}}">{{trans('labels.achieved')}}  <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                <li class="nav-item">
                    <a href="{{url('/activity-achieve')}}" class="nav-link" id="menu_activity_achieved"><i class="fa fa-bolt text-info"></i> Activity Achieved</a>
                </li>
                <li class="nav-item">
                    <a href="{{url('/indicator-achieve')}}" class="nav-link" id="menu_indicator"><i class="fa fa-bolt text-info"></i> Indicator Achieved</a>
                </li>
                <li class="nav-item">
                    <a href="{{url('/narative-achieve')}}" class="nav-link" id="menu_narative_achieve"><i class="fa fa-bolt text-info"></i> Narrative Achieved</a>
                </li>
            </ul>
        </nav>
...
<script>
    var burl = "{{url('/')}}";
    var doc_url = "{{asset('uploads/documents/')}}";
    var asset = "{{asset('img')}}";
</script>
@yield('js')
</body>
