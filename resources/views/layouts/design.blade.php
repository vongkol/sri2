    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a href="{{url('/activity-setting')}}" class="nav-link">{{trans('labels.designed')}} <span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item"><a href="{{url('/indicator')}}" class="nav-link" id="menu_indicator_setting"><i class="fa fa-bolt text-info"></i> Indicator Setting</a></li>
            </ul>
        </nav>
