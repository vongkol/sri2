        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>{{trans('labels.edit_project')}}</strong>&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/project/update')}}" class="form-horizontal" method="post" onsubmit="return confirm('You want to save?')">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$projects->name}}" id="name" name="name" required>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="acronym" class="control-label col-sm-3 lb">{{trans('labels.acronym')}}</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$projects->acronym}}"  id="acronym" name="acronym" >
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        @foreach($ngos as $ngo)
                                            <option value="{{$ngo->id}}" {{$projects->ngo_id==$ngo->id?'selected':''}}>{{$ngo->name}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
