        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>{{trans('labels.create_activity_type')}}</strong>&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/activity_type/save')}}" class="form-horizontal" method="post" onsubmit="return confirm('You want to save?')">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-6">
